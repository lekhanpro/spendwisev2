...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
      ...
      <div className="relative w-full sm:max-w-xl lg:max-w-2xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-3xl shadow-2xl max-h-[90vh] overflow-hidden animate-slide-up">
